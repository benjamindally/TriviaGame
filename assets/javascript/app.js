$(document).ready(function() {
  ...
  var allQuestions = [
    ...
    }, //image for after user selects an answer
    {
    ...
    {
      question:
        "Before California became known as the Golden State, what was the nickname?",
      answerChoices: [
        "Great Coast State",
        "Grizzly Bear State",
        "Giant Sequoia State",
        "America's Fruitbasket",
      ],
      imgUrl: "./assets/images/grizzly.jpg",
    },
    {
      question:
        "Located in Sequia National Park, what is the name of the largest tree in the world?",
      answerChoices: [
        "Major Tom",
        "Howard",
        "General Grant",
    ...
    },
    {
      ...
      answerChoices: [
        ...
        "It has the most biospheres in the U.S.",
        "It is a national monument",
        "It boasts more than 5000 miles of road",
      ],
      imgUrl: "./assets/images/california_coast.jpg",
    },
    {
      question:
        "Mount ______________ is the highest peak in the lower 48 states",
      answerChoices: ["Shasta", "Whitney", "Williamson", "Lyell"],
      imgUrl: "./assets/images/whitney.jpg",
    },
    {
      question:
        "More of the earth's surface can be seen from ___________ than any other peak except Mt. Kilimanjaro",
      answerChoices: [
        "Mount Diablo",
        "Mount Shasta",
        "Mount Whitney",
  ...
  function firstQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3> Sorry, time's up!</h3><h3>The correct answer was 1850.</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3> Sorry, that's incorrect.</h3><h3>The correct answer was 1850.</h3>"
      );
      moveOn();
    });
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[0].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function secondQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3> Sorry, time's up!</h3><h3>The correct answer was 8.</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3> Sorry, that's incorrect.</h3><h3>The correct answer was 8.</h3>"
      );
      moveOn();
    });
    $(".answer_two").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[1].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function thirdQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3> Sorry, time's up!</h3><h3>The correct answer was 'I Love You, California'</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_two").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3> Sorry, that's incorrect.</h3><h3>The correct answer was 'I Love You, California.'</h3>"
      );
      moveOn();
    });
    $(".answer_three").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[2].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function fourthQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3> Sorry, time's up.</h3><h3>The correct answer was Grizzly Bear State.</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3>Sorry, that's incorrect.</h3><h3>The correct answer was Grizzly Bear State.</h3>"
      );
      moveOn();
    });
    $(".answer_two").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[3].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function fifthQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          noInput++;
          $(".question").html(
            "<h3>Sorry, time's up.</h3><h3>The correct answer was General Sherman.</h3>"
          );
          timer = 30;
          moveOn();
        }
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3>Sorry, that's incorrect.</h3><h3>The correct answer was General Sherman.</h3>"
      );
      moveOn();
    });
    $(".answer_two").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[4].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function sixthQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3>Sorry, time's up.</h3><h3>The correct answer was 'It is a national monument.'</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3>Sorry, that's incorrect.</h3><h3>The correct answer was 'It is a national monument.'</h3>"
      );
      moveOn();
    });
    $(".answer_two").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[5].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function seventhQuestion() {
    ...
    function timer() {
      ...
      countdown = setInterval(function() {
        ...
        if (timer === 0) {
          $(".question").html(
            "<h3> Sorry, time's up.</h3><h3>The correct answer was Mount Whitney</h3>"
          );
          noInput++;
          timer = 30;
          moveOn();
    ...
    $(".answer_one").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3>Sorry, that's incorrect.</h3><h3>The correct answer was Mount Whitney.</h3>"
      );
      moveOn();
    });
    $(".answer_two").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[6].imgUrl + ' class="after_image">'
      );
    }
  }
  ...
  function eighthQuestion() {
    ...
    $(".answer_two").on("click", function() {
      incorrect++;
      $(".question").html(
        "<h3>Sorry, that's incorrect.</h3><h3>The correct answer was Mount Diablo.</h3>"
      );
      moveOn();
    });
    $(".answer_three").on("click", function() {
    ...
    function moveOn() {
      ...
      $(".question").append(
        "<img src=" + allQuestions[7].imgUrl + ' class="after_image">'
      );
    }
  }
